...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services__ = __webpack_require__(389);
...
var ServicesPage = /** @class */ (function () {
    ...
    ServicesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-services',template:/*ion-inline-start:"/media/dev/34d762b3-5aaa-4010-8e57-6a9c60fa60ed/ionic/nursing/src/pages/services/services.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Services  <ion-icon style="float: right;" name="information-circle" (click)="viewServices()"></ion-icon></ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n\n\n\n  <div class="box-imgss" *ngFor="let services of servicesList" >\n  <img src={{services.service_type_image}} (click)="servicecheck(services.id)">\n\n  </div>\n\n\n</ion-content>\n'/*ion-inline-end:"/media/dev/34d762b3-5aaa-4010-8e57-6a9c60fa60ed/ionic/nursing/src/pages/services/services.html"*/,
        }),
