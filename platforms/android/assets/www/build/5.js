...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__payment__ = __webpack_require__(377);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_stripe__ = __webpack_require__(213);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PaymentPage = /** @class */ (function () {
    function PaymentPage(navCtrl, navParams, alertCtrl, userServices, loadingCtrl, stripe, toast) {
        var _this = this;
        ...
        if (!this.subscription) {
            ...
            this.userServices.priceList(this.serviceTypeid).subscribe(function (res) {
                if (res.message = "successfull") {
                    console.log(res);
                    _this.priceList = res.result;
                    console.log("price data", _this.priceList);
            ...
            setTimeout(function () {
                __WEBPACK_IMPORTED_MODULE_3_jquery__(".paybox").show();
            }, 1000);
        }
    }
    ...
    PaymentPage.prototype.presentLoadingDefault1 = function () {
        var loading = this.loadingCtrl.create({
    ...
    PaymentPage.prototype.pay = function () {
        ...
        this.userServices.request_care(this.requestData, this.plan_id).subscribe(function (res) {
            ...
            if (res.message == "successfull") {
                ...
                _this.requestDetail['service_type'] = res.result.service_type;
                _this.requestDetail['services'] = res.result.services;
                _this.requestDetail['requestId'] = res.result.id;
                //this.requestDetail['nurseMobile'] = this.requestData.nurseMobile;
                console.log(_this.requestDetail);
                //  this.navCtrl.setRoot(CompleteRequestPage,{'requestDetails':this.requestDetail,'requestData':this.requestData});
                //$(".paybox").hide();
                _this.navCtrl.setRoot('NursingdemandmapPage', { 'requestData': _this.requestData.nurseMobile, 'request_id': res.result.id });
            }
            else {
    ...
    PaymentPage.prototype.PayAmount = function () {
        var _this = this;
        var loading = this.loadingCtrl.create({
            content: 'Please wait...'
        });
        ...
        this.stripe.createCardToken(card).then(function (token) {
            ...
            _this.total_price = _this.total_price * 100;
            var params = 'source=' + token.id + '&amount=' + _this.total_price + '&currency=usd';
            _this.userServices.paytoStripe(params).subscribe(function (response) {
                loading.dismiss();
    ...
    PaymentPage.prototype.viewPrice = function (plan) {
    ...
    PaymentPage.prototype.checkValue = function () {
    ...
    PaymentPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__ionic_native_stripe__["a" /* Stripe */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* ToastController */]])
    ], PaymentPage);
    return PaymentPage;
}());
