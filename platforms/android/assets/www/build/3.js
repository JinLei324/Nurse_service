...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__requesthistory__ = __webpack_require__(385);
...
var RequesthistoryPage = /** @class */ (function () {
    function RequesthistoryPage(navCtrl, navParams, userServices, alertCtrl, loadingCtrl) {
        ...
        this.completeData = [];
        this.datatrue = false;
        this.datatrue1 = false;
        this.datatrue2 = false;
        this.scheduleDetails = [];
        this.scheduleAddion = [];
        this.user_id = localStorage.getItem('user_id');
        this.loadData();
    }
    RequesthistoryPage_1 = RequesthistoryPage;
    RequesthistoryPage.prototype.loadData = function () {
        var _this = this;
        this.userServices.getRequestHistory(this.user_id).subscribe(function (res) {
            console.log(res);
            _this.currentData = res.result.request.Current;
            _this.scheduleData = res.result.request.Scheduled;
            _this.completeData = res.result.request.Completed;
            _this.scheduledataL = _this.scheduleData.length;
            _this.currentdataLength = _this.currentData.length;
            _this.completeDatal = _this.completeData.length;
            console.log("length of scff data", _this.completeDatal);
            if (_this.currentdataLength == 1) {
                _this.datatrue = true;
            }
            if (_this.scheduledataL == 1 || _this.scheduledataL >= 1) {
                _this.datatrue1 = true;
            }
            if (_this.completeDatal == 1 || _this.completeDatal >= 1) {
                _this.datatrue2 = true;
            }
        });
    };
    ...
    RequesthistoryPage.prototype.presentLoadingDefault = function () {
    ...
    RequesthistoryPage.prototype.presentAlert = function () {
        __WEBPACK_IMPORTED_MODULE_3_jquery__(".close-rew").show();
    };
    RequesthistoryPage.prototype.hidepooss1 = function () {
        __WEBPACK_IMPORTED_MODULE_3_jquery__(".close-rew").hide();
    };
    RequesthistoryPage.prototype.hidepooss = function () {
        __WEBPACK_IMPORTED_MODULE_3_jquery__(".pop-box-rating").show();
        __WEBPACK_IMPORTED_MODULE_3_jquery__(".close-rew").hide();
    };
    RequesthistoryPage.prototype.close_done = function () {
        this.navCtrl.push(RequesthistoryPage_1);
    };
    RequesthistoryPage.prototype.viewDetails = function (serviceName, nurse_id, nurse_type, visit_charge, service) {
    ...
    RequesthistoryPage.prototype.aditionDetails = function (visit_type, gender, address, number, doctor_order, medical_fac, needs) {
    ...
    RequesthistoryPage.prototype.popup = function () {
        __WEBPACK_IMPORTED_MODULE_3_jquery__('.close-rew2').show();
    };
    RequesthistoryPage.prototype.cancel = function () {
        __WEBPACK_IMPORTED_MODULE_3_jquery__('.close-rew2').hide();
    };
    RequesthistoryPage.prototype.ok = function (id) {
        var _this = this;
        console.log(id);
        this.userServices.cancelRequest(id).subscribe(function (res) {
            console.log(res);
    ...
    RequesthistoryPage.prototype.completeView = function (serviceName, nurse_id, nurse_type, visit_charge, service) {
        this.scheduleDetails['serviceType'] = serviceName;
        this.scheduleDetails['nurse_id'] = nurse_id;
        this.scheduleDetails['nurseType'] = nurse_type;
        this.scheduleDetails['visitCharge'] = visit_charge;
